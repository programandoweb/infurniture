...
const App=(props)=>{
  ...
  const getInit=()=>{
    ...
    Functions.PostAsync("Websites","getNoticias",data,context,{name:"callbackInit",funct:callbackInit})
  }
  ...
  const onSubmit=(e)=>{
    ...
    let data        =   inputs
        data.user   =   context.Store.get("user").token
        data.app    =   JSON.stringify(modulo)
    Functions.PostAsync("Websites","setNoticias",data,context,{name:"callbackContinue",funct:callbackContinue})
  }
                        ...
                        <form onSubmit={onSubmit}>
                          <div className="card-body">
                            ...
                            <div className="row mb-2">
                              ...
                              <div className="col">
                                <textarea name="descripcion" className="form-control" onChange={onChange} placeholder="descripción" />
                              </div>
                            </div>
