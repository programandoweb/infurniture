...
const App=(props)=>{
  ...
  const getInit=()=>{
    ...
    Functions.PostAsync("Websites","getTienda",data,context,{name:"callbackInit",funct:callbackInit})
  }
  ...
  const onSubmit=(e)=>{
    ...
    let data        =   inputs
        data.user   =   context.Store.get("user").token
        data.app    =   JSON.stringify(modulo)
    Functions.PostAsync("Websites","setTienda",data,context,{name:"callbackContinue",funct:callbackContinue})
  }
