...
const App=(props)=>{
  ...
  return <>
            {!networkError?<>
              <BrowserRouter>
                <Switch>
                  <Route exact path={"/"} render={()=><Web networkError={networkError} setNetworkError={setNetworkError} alert={alert} setAlert={setAlert} user={user} setUser={setUser} modalShow={modalShow} setModalShow={setModalShow}/>}/>
                  ...
                  <Route exact path={"/test*"} render={()=><Test networkError={networkError} setNetworkError={setNetworkError} alert={alert} setAlert={setAlert} user={user} setUser={setUser} modalShow={modalShow} setModalShow={setModalShow}/>}/>
                  <Route exact path={"/apanel*"} render={()=><>
                    <Modal modalShow={modalShow} setModalShow={setModalShow}/>
                    <Alert alert={alert} setAlert={setAlert} />
                    {user?<Application networkError={networkError} setNetworkError={setNetworkError} alert={alert} setAlert={setAlert} user={user} setUser={setUser} modalShow={modalShow} setModalShow={setModalShow}/>:<Auth user={user} setUser={setUser} alert={alert} setAlert={setAlert}/>}
                    </>
                  }/>
                  <Route exact path={"/auth*"} render={()=><Auth user={user} setUser={setUser} alert={alert} setAlert={setAlert}/>}/>
